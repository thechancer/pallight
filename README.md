...
[![GitHub Release](https://img.shields.io/github/release/your-github-username/ha-pallight.svg)](https://github.com/your-github-username/ha-pallight/releases)
...
The integration uses the **Xlink local UDP protocol** on port 5987, reverse-engineered from pcap captures of the native PalLighting Android app.
